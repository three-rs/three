...
impl Material {
    ...
    pub fn mesh_basic() -> builder::MeshBasic{
        builder::MeshBasic::new()
    }

    pub fn mesh_lambert() -> builder::MeshLambert{
        builder::MeshLambert::new()  
    }

    pub fn mesh_phong() -> builder::MeshPhong{
        builder::MeshPhong::new()
    }

    pub fn mesh_pbr() -> builder::MeshPbr{
        builder::MeshPbr::new()
     }
}